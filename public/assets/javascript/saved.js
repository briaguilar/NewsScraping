...
$(document).ready(function () {
    ...
    function handleArticleDelete() {
        ...
        // We grab the id of the article to delete from the panel element the delete button sites inside 
    ...
    function handleNoteSave() {
        ...
        // If we actually have data typed into the note input field, format it and pos tit to the
        // "/api/notes" route and send the formatted noteData as well
        if (newNote) {
            noteData = {
